...
public class Theme1PageRetrievePassword extends PageRetrievePassword {
	@Override
	protected View onCreateContentView(Context context) {
		View view = LayoutInflater.from(context).inflate(getLayoutId("bbs_theme1_retrievepassword"), null);
		return view;
	}
