...
public class Theme1PageRetrievePasswordConfirm extends PageRetrievePasswordConfirm {
	@Override
	protected View onCreateContentView(Context context) {
		View view = LayoutInflater.from(context).inflate(getLayoutId("bbs_theme1_retrievepasswordconfirm"), null);
		return view;
	}
