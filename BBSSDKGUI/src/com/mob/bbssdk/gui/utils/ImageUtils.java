...
//	}
	 ...
	 * @return bitmap
	 */
	public static Bitmap getBitmap(final int resId, final int maxWidth, final int maxHeight) {
		BitmapFactory.Options options = new BitmapFactory.Options();
	 ...
	 * @return 圆形图片
	 */
	public static Bitmap toRound(final Bitmap src, int borderSize, int borderColor) {
	 ...
	 * @return 圆角图片
	 */
	public static Bitmap toRoundCorner(final Bitmap src, final float radius, int borderSize, int borderColor) {
	 ...
	 * @return 圆角边框图
	 */
	public static Bitmap addCornerBorder(final Bitmap src, final int borderSize, final int color, final float cornerRadius) {
	 ...
	 * @return 圆角边框图
	 */
	public static Bitmap addCornerBorder(final Bitmap src, final int borderSize, final int color, final float cornerRadius, final boolean recycle) {
	 ...
	 * @return 圆形边框图
	 */
	public static Bitmap addCircleBorder(final Bitmap src, final int borderSize, final int color) {
	 ...
	 * @return 圆形边框图
	 */
	public static Bitmap addCircleBorder(final Bitmap src, final int borderSize, final int color, final boolean recycle) {
	 ...
	 * @return 边框图
	 */
	private static Bitmap addBorder(final Bitmap src, final int borderSize
			, final int color, final boolean isCircle
	...
	public static Bitmap addTextWatermark(final Bitmap src, final String content, final int textSize
			, final int color, final float x, final float y) {
	 ...
	 * @return 模糊后的图片
	 */
	public static Bitmap fastBlur(final Bitmap src, final float scale, final float radius) {
	...
	public static Bitmap renderScriptBlur(final Bitmap src, final float radius) {
	 ...
	 * @return 质量压缩后的图片
	 */
	public static Bitmap compressByQuality(final Bitmap src, final int quality) {
	 ...
	 * @return 质量压缩后的图片
	 */
	public static Bitmap compressByQuality(final Bitmap src, final int quality, final boolean recycle) {
		if (isEmptyBitmap(src)) {
			return null;
		}
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
