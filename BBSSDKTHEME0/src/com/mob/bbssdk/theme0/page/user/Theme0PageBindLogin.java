...
/**
 * Created by yychen on 2017/11/17.
 */

public class Theme0PageBindLogin extends BasePageWithTitle {
	...
	protected View onCreateContentView(Context context) {
		View view = LayoutInflater.from(context).inflate(getLayoutId("bbs_theme0_activity_bind"), null);
		return view;
	}
